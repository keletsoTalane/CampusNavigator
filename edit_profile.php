...
<body>
    <div id="box">
        <form action="edit_profile_process.php" method="POST">
            ...
            <div style="font-size: 20px; margin: 10px;">Edit Profile</div>
            <h4>Username</h4>
            <input id="text" type="text" name="user_name" value="<?php echo $user_data['user_name']; ?>"><br><br>
            <h4>User Email</h4>
            <input id="text" type="text" name="email" value="<?php echo $user_data['email']; ?>"><br><br>
            <h4>Password</h4>
            <input id="text" type="password" name="password" value=""><br><br>
